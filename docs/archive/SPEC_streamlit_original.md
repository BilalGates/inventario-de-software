> ⚠️ **DOCUMENTO HISTÓRICO — NO ES LA FUENTE VIGENTE.**
>
> Esta es la especificación **original basada en Streamlit**, anterior a la
> migración a PySide6 (v2.0). Se conserva solo como referencia histórica del
> diseño funcional inicial.
>
> La arquitectura **vigente** es **PySide6 + MySQL**. Consulta:
> - [docs/ARQUITECTURA.md](../ARQUITECTURA.md) — arquitectura actual
> - [docs/MODELO_DATOS.md](../MODELO_DATOS.md) — modelo de datos actual
> - [docs/OPERACION.md](../OPERACION.md) — instalación y operación
> - [docs/adr/0001-ui-pyside6.md](../adr/0001-ui-pyside6.md) — por qué PySide6 y no Streamlit
>
> Todo lo que este documento dice sobre **Streamlit**, la carpeta `pages/`,
> `streamlit run app.py` o "no usar PyQt" está **obsoleto**. La lógica funcional
> útil (reglas de negocio, modelo de datos, normalización) se ha migrado a la
> documentación vigente listada arriba.
